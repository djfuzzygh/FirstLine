#!/bin/bash
# FirstLine Critical Fixes Script

echo "🔧 Applying critical fixes to FirstLine Web App..."

# Backup original file
cp web_app/main.js web_app/main.js.backup
echo "✅ Backup created: main.js.backup"

# Create the fixed renderFollowUp function
cat > /tmp/renderFollowUp_fix.js << 'ENDOFFUNCTION'
...
function renderFollowUp(questions) {
    ...
    questions.forEach((q, idx) => {
        ...
        // Detect if question is open-ended (no options or contains certain keywords)
...
echo "📝 Created fixed renderFollowUp function"
echo ""
echo "⚠️  MANUAL STEP REQUIRED:"
echo "Please replace the renderFollowUp function in web_app/main.js (starting at line 347)"
echo "with the content from /tmp/renderFollowUp_fix.js"
echo ""
echo "Or run: sed -i.bak '347,396d' web_app/main.js && sed -i '' '346r /tmp/renderFollowUp_fix.js' web_app/main.js"
